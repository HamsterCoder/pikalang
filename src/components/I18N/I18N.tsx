...
const dictionary: Record<string, I18NTranslation | ((values: Record<string, number | string>) => I18NTranslation)> = {
...
function translate(lang: I18NLangs, key: string,  values?: Record<string, number | string>): string {
    const translationMethod = dictionary[key];

    if (typeof translationMethod === 'function' && typeof values !== 'undefined') {
        return translationMethod(values)[lang];
    } 
    
    if (typeof translationMethod !== 'function' && typeof translationMethod !== 'undefined') {
...
export const I18N: FunctionComponent<I18NProps> = ({ textKey, lang, values }) => {    
